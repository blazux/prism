...
- **Terminal** — a real, full TTY into the agent's workspace container. Toggle with **Ctrl+`**. `vim`, `htop`, colours, package installs — all work. For when you trust the agent right up until you don't.
