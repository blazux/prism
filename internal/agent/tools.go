		...
		Function: ollama.ToolFunction{
			...
			Parameters: ollama.ToolParameters{
				...
				Properties: map[string]ollama.ToolProperty{
					...
					"reindex":                     {Type: "boolean", Description: "Explicit user agreement to rebuild index at next restart; required when changing embedding model/provider or resetting to different defaults"},
